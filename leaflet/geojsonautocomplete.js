...
(function ($) {
    ...
    function createDropDown(withPaging) {
        ...
        for (var i = 0; i < loopCount; i++) {
            if (features[i].properties.title.indexOf($("#searchBox")[0].value.toUpperCase()) == 0) {
                $("#resultsDiv").remove();
        ...
        for (var i = 0; i < loopCount; i++) {
            ...
            if (features[i].properties.title.indexOf($("#searchBox")[0].value.toUpperCase()) == 0) {
                ...
                //html += "<span id='listElementContent" + i + "' class='autocomplete-content'><img src='leaflet/images/" + features[i].properties.image + "' class='autocomplete-iconStyle' align='middle'>";
                html += "<font size='2' color='#333' class='autocomplete-title'>" + features[i].properties.title + "</font><font id='dct' size='1' color='#8c8c8c'> " + "<span id='space'></span>" + features[i].properties.description + "<font></span></li>";
